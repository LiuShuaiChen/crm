...
/**
 * Servlet implementation class DictionaryTypeAddController
 * @author LauShuaichen
 */
@WebServlet("/settings/dictionary/type/add.do")
public class DictionaryTypeAddController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		System.out.println("/crm002/src/com/bjpowernode/crm/settings/dictionary/web/controller/DictionaryTypeAddController.java");
