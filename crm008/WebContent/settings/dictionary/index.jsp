<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	System.out.println("/crm002/WebContent/settings/dictionary/index.jsp");
%>
	...
	<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
		...
		<div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
			...
			<ul id="no1" class="nav nav-pills nav-stacked">
				<li class="liClass"><a href="settings/dictionary/type/list.do" target="workareaFrame"><span class="glyphicon glyphicon-book"></span> 字典类型JSP</a></li>
				<li class="liClass"><a href="settings/dictionary/value/list.do" target="workareaFrame"><span class="glyphicon glyphicon-list"></span> 字典值JSP</a></li>
			</ul>
