...
<script type="text/javascript">
	$(function(){
		...
		$("#updateBtn").click(function(){
			...
			var deptName = $("#create-org").val();
			var allowIps = $("#edit-allowIps").val();
			
			$.post(
				"setting/qx/user/update.do",
				{
					"id":id,
					"name":name,
					"loginPwd":loginPwd,
	...
	<div>
		<div style="position: relative; left: 30px; top: -10px;">
			<div class="page-header">
				<h3>用户明细 <small id="myName1"></small></h3>
			</div>
			...
			<div class="tab-pane fade in active" id="role-info">
				<div style="position: relative; top: 20px; left: -30px;">
					...
					<div style="position: relative; left: 40px; height: 30px; top: 140px;">
						...
						<div style="height: 1px; width: 600px; background: #D5D5D5; position: relative; top: -20px;"></div>
						<button style="position: relative; left: 76%; top: -40px;" type="button" class="btn btn-default" data-toggle="modal" data-target="#editUserModal" id="editBtn" ><span class="glyphicon glyphicon-edit"></span> 编辑</button>
					</div>
				</div>
			</div>
