...
<body>
	...
	<form class="form-horizontal" role="form" id="myForm" action="settings/dictionary/value/save.do" method="post">
					
		<div class="form-group">
			<label for="create-dicTypeCode" class="col-sm-2 control-label">字典类型编码JSP<span style="font-size: 15px; color: red;">*</span></label>
			<div class="col-sm-10" style="width: 300px;">
				<select class="form-control" id="create-dicTypeCode" name="code" style="width: 200%;">
