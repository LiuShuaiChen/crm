...
<script type="text/javascript"
	src="jquery/zTree_v3-master/js/jquery.ztree.all.min.js"></script>
...
$(function(){
	...
	function showDetail(){
		$.post(
			...
			function(data){
				...
				$("#myLockStatus").html(data.lockStatus);
				$("#mydeptId").html(data.deptId);
	...
	$("#updateBtn").click(function(){
			...
			var loginAct = $("#edit-loginActNo").val(data.loginAct);
			var name = $("#edit-username").val(data.name);
			var loginPwd = $("#edit-loginPwd").val(data.loginPwd);
			var email = $("#edit-email").val(data.email);
			var expireTime = $("#edit-expireTime").val(data.expireTime);
			var lockStatus = $("#edit-lockStatus").val(data.lockStatus);
			var deptId = $("#create-org").val(data.deptId);
			var allowIps = $("#edit-allowIps").val(data.allowIps);
			
			$.post(
			
					"settings/qx/user/update.do",
					{"id":id,"loginAct":loginAct,"name":name,"loginPwd":loginPwd,"email":email,"expireTime":expireTime,"lockStatus":lockStatus,"deptId":deptId,"allowIps":allowIps},
					function(data){
						if (data == "success") {
							showDetail();
...
<body>
				...
				<div class="modal-body">
					<table width="90%" border="0" cellspacing="0" cellpadding="0"
						...
						<tr>
							<td width="42%">
								<div class="list_tit"
									style="border: solid 1px #D5D5D5; background-color: #F4F4B5;">
									张三，未分配角色列表</div>
							</td>
							<td width="15%">&nbsp;</td>
							<td width="43%">
						...
						<tr>
							<td><select size="15" name="srcList" id="srcList"
							...
							<td><select name="destList" size="15" multiple="multiple"
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 300px;">
								<input type="text" class="form-control" id="create-org"
									placeholder="输入部门名称，自动补全" value="市场部">
							</div>
						</div>
						<div class="form-group">
	...
	<div>
		<div style="position: relative; left: 30px; top: -10px;">
			...
			<div
				style="position: relative; height: 50px; width: 250px; top: -72px; left: 80%;">
		...
		<div id="myTabContent" class="tab-content">
			<div class="tab-pane fade in active" id="role-info">
				<div style="position: relative; top: 20px; left: -30px;">
					<div
						style="position: relative; left: 40px; height: 30px; top: 20px;">
						...
						<div
							style="height: 1px; width: 600px; background: #D5D5D5; position: relative; top: -20px;"></div>
					</div>
					<div
						style="position: relative; left: 40px; height: 30px; top: 40px;">
					...
					<div
						style="position: relative; left: 40px; height: 30px; top: 60px;">
					...
					<div
						style="position: relative; left: 40px; height: 30px; top: 80px;">
					...
					<div
						style="position: relative; left: 40px; height: 30px; top: 100px;">
					...
					<div
						style="position: relative; left: 40px; height: 30px; top: 120px;">
					...
					<div
						style="position: relative; left: 40px; height: 30px; top: 140px;">
						...
						<div
							style="height: 1px; width: 600px; background: #D5D5D5; position: relative; top: -20px;"></div>
						<button style="position: relative; left: 76%; top: -40px;"
							type="button" class="btn btn-default" id="editBtn">
			...
			<div class="tab-pane fade" id="permission-info">
				<div style="position: relative; top: 20px; left: 0px;">
					<ul id="treeDemo" class="ztree"
						style="position: relative; top: 15px; left: 15px;"></ul>
					<div style="position: relative; top: 30px; left: 76%;">
						<button type="button" class="btn btn-default" data-toggle="modal"
							data-target="#assignRoleForUserModal">
